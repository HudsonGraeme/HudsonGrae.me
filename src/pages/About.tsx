      ...
      <VStack w="100%" justify="space-evenly" minH="80vh">
        ...
        >
          ...
          <Text>
            ...
            <br />I realized I wanted to figure out how to make desktop apps, so
            after giving up assembly I tried my hand at swift. It took me about
            a year to get my first successful web request to go through (at that
            time it was to Tesla&apos;s API which wasn&apos;t public but had
            been documented by @timdorr). After figuring out swift I moved onto
            C, C++, C#, Java, some weird foray into XPaths for XML searching
            (would rather encounter a 512 character regex than deal with those
            again), python (of course) then ultimately Javascript. <br />
            <br />
